...
$a_nat = config_get_path("installedpackages/snortglobal/rule/{$id}/ftp_server_engine/item", []);
...
if ($_POST['save']) {
	...
	if (!$input_errors) {
		...
		config_set_path("installedpackages/snortglobal/rule/{$id}/ftp_server_engine/item", $a_nat);
