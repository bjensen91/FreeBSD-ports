 ...
 * Copyright (c) 2016-2024 Rubicon Communications, LLC (OpenSourceCompany)
...
function pfBlockerNG_get_header($mode='') {
	...
	if ($mode == 'js') {
		...
		// FA Icons
		$faicon = [
			['times text-danger', 'check text-success', 'filter', 'list-ol'],
			['times text-danger', 'history', 'percent', 'list-ol']
		];
