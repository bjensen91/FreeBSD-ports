...
ZEND_BEGIN_MODULE_GLOBALS(libresense)
	int s;
	int inets;
	int inets6;
	int csock;
ZEND_END_MODULE_GLOBALS(libresense)

ZEND_EXTERN_MODULE_GLOBALS(libresense)

#define LIBRESENSE_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(libresense, v)
